...
<h1><a name="_Toc69891986">Lab 1: Creating a Herbivore</a></h1>

<h2><a name="_Toc69891987">Lab Objective</a>  </h2>
...
<h2><a name="_Toc69891988">Exercise 1 – Create a Simple Herbivore</a></h2>

<h3><a name="_Toc69891989">Create a Simple Herbivore</a> </h3>
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69891990"><span
style='font-size:10.0pt;font-family:"Microsoft Sans Serif"'>1.1<span
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69891991"><span
...
<p class=Code>[assembly: <b><span style='color:navy'>AuthorInformation</span></b>(&quot;Your
Name&quot;, &quot;someone@microsoft.com&quot;)]</p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69891992">1.3<span
...
<p class=Code>  [Carnivore(<span style='color:blue'>false</span>)]</p>

<p class=lab2tpn><span style='font-size:10.0pt;font-family:"Microsoft Sans Serif"'>&nbsp;</span></p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69891993">1.4<span
...
<p class=Code>[AnimalSkin(AnimalSkinFamily.Inchworm)]</p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69891994"><span
...
<p class=Code>[MaximumEnergyPoints(20)]</p>

<p class=Code>[EatingSpeedPointsAttribute(0)]</p>

<p class=Code>[AttackDamagePointsAttribute(12)]</p>

<p class=Code>[DefendDamagePointsAttribute(12)]</p>

<p class=Code>[MaximumSpeedPointsAttribute(16)]</p>

<p class=Code>[CamouflagePointsAttribute(10)]</p>

<p class=Code>[EyesightPointsAttribute(20)]</p>

<p class=MsoNormal>&nbsp;</p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69891995">1.6<span
...
<p class=Code><span style='color:green'>// The current plant we're going after</span> 
</p>

<p class=Code>PlantState targetPlant = <span style='color:blue'>null</span>;&nbsp;&nbsp;&nbsp;</p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69891996">1.7<span
...
<p class=Code>Idle += <span style='color:blue'>new</span>
IdleEventHandler(MyAnimal_Idle);</p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69891997">1.8<span
...
<p class=Code><span style='color:blue'>void</span> MyAnimal_Idle (<span
style='color:blue'>object</span> sender, <b><span style='color:navy'>IdleEventArgs</span></b>
e)</p>
...
<p class=Code>        <span style='color:blue'>if</span> (CanReproduce)</p>

<p class=Code>            BeginReproduction(<span style='color:blue'>null</span>);</p>

<p class=Code>&nbsp;</p>

<p class=Code>        // If we can eat and we have a target plant, eat </p>

<p class=Code>        <span style='color:blue'>if</span> (CanEat)</p>

<p class=Code>        {</p>

<p class=Code>            WriteTrace(&quot;Hungry.&quot;);</p>

<p class=Code>            <span style='color:blue'>if</span> (!IsEating)</p>
...
<p class=Code>                <span style='color:blue'>if</span> (targetPlant
...
(WithinEatingRange(targetPlant))</p>
...
<b><span style='color:navy'>MovementVector</span></b>(targetPlant.Position,
2));</p>
...
<p class=Code>                            <span style='color:blue'>int</span>
RandomX = OrganismRandom.Next(0, WorldWidth - 1);</p>

<p class=Code>                            <span style='color:blue'>int</span>
RandomY = OrganismRandom.Next(0, WorldHeight - 1);</p>

<p class=Code>&nbsp;</p>

<p class=Code>                            BeginMoving(<span style='color:blue'>new</span>
<b><span style='color:navy'>MovementVector</span></b>(<span style='color:blue'>new</span>
<b><span style='color:navy'>Point</span></b>(RandomX, RandomY), 2));</p>
...
<p class=Code>                <span style='color:blue'>if</span> (IsMoving)</p>
...
<p class=Code>    <span style='color:blue'>catch</span> (<b><span
style='color:navy'>Exception</span></b> exc)</p>
...
<p class=Code><span style='color:blue'>bool</span> ScanForTargetPlant()</p>
...
<p class=Code>        <b><span style='color:navy'>ArrayList</span></b>
foundCreatures = Scan();</p>
...
<p class=Code>            <span style='color:blue'>foreach</span> (<b><span
style='color:navy'>OrganismState</span></b> organismState <span
style='color:blue'>in</span> foundCreatures)</p>

<p class=Code>            {</p>

<p class=Code>                <span style='color:blue'>if</span> (organismState
<span style='color:blue'>is</span> <b><span style='color:navy'>PlantState</span></b>)</p>

<p class=Code>                {</p>

<p class=Code>                    targetPlant = (<b><span style='color:navy'>PlantState</span></b>)organismState;</p>

<p class=Code>                    BeginMoving(<span style='color:blue'>new</span>
<b><span style='color:navy'>MovementVector</span></b>(organismState.Position,
2));</p>
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69891998">1.9<span
...
<p class=Code>Load += <span style='color:blue'>new</span> LoadEventHandler(MyAnimal_Load);</p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69891999">1.10<span
...
<p class=Code><span style='color:blue'>void</span> MyAnimal_Load(<span
style='color:blue'>object</span> sender, <b><span style='color:navy'>LoadEventArgs</span></b>
e)</p>
...
<p class=Code>            // See if our target plant still exists (it may have
died) </p>

<p class=Code>            // LookFor returns null if it isn't found </p>

<p class=Code>            targetPlant = (<b><span style='color:navy'>PlantState</span></b>)LookFor(targetPlant);</p>
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892000">1.11<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span>Build the animal DLL.</a>  </h3>

<p class=MsoNormal>Build the animal DLL by selecting <b>Build | Build Solution</b>
</p>

<p class=MsoNormal>&nbsp;</p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892001">1.12<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<h2><a name="_Toc69892002">Note</a></h2>
...
<h2><a name="_Toc69892003">Lab Summary</a></h2>
...
<h2><a name="_Toc69892004">Exercise 2 – Handling an Attacked Event</a></h2>
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892005">2.1<span
style='font:7.0pt "Times New Roman"'>&nbsp; </span>Open the animal you created
in Exercise 1 (Simple Herbivore)</a> </h3>
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892006">2.2<span
...
<p class=Code>Attacked += <span style='color:blue'>new</span>
AttackedEventHandler(MyAnimal_Attacked);</p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892007">2.3<span
...
<p class=Code><span style='color:green'>// Fired if we're being attacked</span>
<br>
<span style='color:blue'>void</span> MyAnimal_Attacked(object sender,
AttackedEventArgs e) { <br>
&nbsp; <span style='color:blue'>if</span>(e.Attacker.IsAlive) <br>
&nbsp; { <br>
&nbsp;&nbsp;&nbsp; AnimalState theAttacker = e.Attacker; <br>
&nbsp;&nbsp;&nbsp; BeginDefending(theAttacker); <span style='color:green'>//defend
against the attacker</span> <br>
&nbsp; <br>
&nbsp;&nbsp;&nbsp; WriteTrace(&quot;Run away to some random point&quot;); <br>
&nbsp;&nbsp;&nbsp; int X= OrganismRandom.Next(0, WorldWidth - 1); <br>
&nbsp;&nbsp;&nbsp; int Y= OrganismRandom.Next(0, WorldHeight - 1); <br>
&nbsp;&nbsp;&nbsp; BeginMoving(<span style='color:blue'>new</span>
MovementVector(<span style='color:blue'>new</span> Point(X,Y), 10)); <br>
&nbsp; }<span style='font-family:"Microsoft Sans Serif"'> <br>
}</span><span style='font-size:9.5pt'>&nbsp;</span> </p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892008">2.4<span
...
style='font-size:10.0pt;font-family:Symbol'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span>Build the animal DLL from within the IDE by selecting <b>Build | Build
Solution</b></p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892009">2.5<span
style='font:7.0pt "Times New Roman"'>&nbsp; </span>Introduce the Herbivore into
the Terrarium in Terrarium Mode.</a>  </h3>
...
<h2><a name="_Toc69892010">Lab Summary</a></h2>
...
<h2><a name="_Toc69892011">Exercise 3 – Communication</a></h2>
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892012">3.1<span
style='font:7.0pt "Times New Roman"'>&nbsp; </span>Open the animal you created
in Exercise 1 (Simple Herbivore)</a> </h3>
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892013">3.2<span
style='font:7.0pt "Times New Roman"'>&nbsp; </span>Subscribe to the
...
<p class=Code>MoveCompleted +=<span style='color:blue'>new</span> <b><span
style='color:navy'>MoveCompletedEventHandler</span></b>(MyAnimal_MoveCompleted);</p>

<p class=MsoNormal>&nbsp;</p>

<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892014">3.3<span
...
MyAnimal_MoveCompleted(<span style='color:blue'>object</span> sender, <b><span
style='color:navy'>MoveCompletedEventArgs</span></b> e)</p>

<p class=Code>{</p>

<p class=Code>    // Reset the antenna value</p>

<p class=Code>    <span style='color:blue'>this</span>.Antennas.AntennaValue =
0;</p>
...
<p class=Code>    <span style='color:blue'>if</span> (e.Reason == <b><span
style='color:navy'>ReasonForStop</span></b>.Blocked)</p>

<p class=Code>    { </p>

<p class=Code>        WriteTrace(&quot;Something's blocking my way.&quot;);</p>

<p class=Code>        <span style='color:blue'>if</span> (e.BlockingOrganism <span
style='color:blue'>is</span> <b><span style='color:navy'>AnimalState</span></b>)</p>

<p class=Code>        { </p>

<p class=Code>            <b><span style='color:navy'>AnimalState</span></b>
blockingAnimal = (<b><span style='color:navy'>AnimalState</span></b>)e.BlockingOrganism;</p>

<p class=Code>            <span style='color:blue'>if</span>
(blockingAnimal.AnimalSpecies.IsSameSpecies(<span style='color:blue'>this</span>.Species))</p>

<p class=Code>            { </p>

<p class=Code>                // Signal to our friend to move out of our way.</p>

<p class=Code>                WriteTrace(&quot;One of my friends is blocking my
way.  I'll ask him to move.&quot;);</p>
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892015">3.4<span
...
<p class=Code><span style='color:blue'>void</span> ShouldIMoveForMyFriend()</p>
...
<p class=Code>        <span style='color:blue'>if</span> (foundAnimals.Count
&gt; 0)</p>
...
<p class=Code>            <span style='color:blue'>foreach</span> (<b><span
style='color:navy'>OrganismState</span></b> organismState <span
style='color:blue'>in</span> foundAnimals)</p>

<p class=Code>            {</p>

<p class=Code>                <span style='color:blue'>if</span> (organismState
<span style='color:blue'>is</span> <b><span style='color:navy'>AnimalState</span></b>)</p>

<p class=Code>                {</p>

<p class=Code>                    <b><span style='color:navy'>AnimalState</span></b>
visibleAnimal = (<b><span style='color:navy'>AnimalState</span></b>)organismState;</p>
...
<p class=Code>                    <span style='color:blue'>if</span> (visibleAnimal.Species.IsSameSpecies(<span
style='color:blue'>this</span>.Species))</p>

<p class=Code>                    {</p>

<p class=Code>                        // If the animal's antenna value is 13,
it means they're blocked (see the MoveCompletedEvent method).</p>

<p class=Code>                        <span style='color:blue'>if</span>
(visibleAnimal.Antennas.AntennaValue == 13)</p>

<p class=Code>                        {</p>

<p class=Code>                            // We're blocking our friend, so we
should move.</p>

<p class=Code>                            WriteTrace(&quot;I'm blocking one of
my friends.  I should move.&quot;);</p>

<p class=Code>&nbsp;</p>

<p class=Code>                            <span style='color:blue'>int</span>
newX = <span style='color:blue'>this</span>.Position.X -
(visibleAnimal.Position.X - <span style='color:blue'>this</span>.Position.X);</p>

<p class=Code>                            <span style='color:blue'>int</span>
newY = <span style='color:blue'>this</span>.Position.Y -
(visibleAnimal.Position.Y - <span style='color:blue'>this</span>.Position.Y);</p>

<p class=Code>&nbsp;</p>

<p class=Code>                            BeginMoving(<span style='color:blue'>new</span>
<b><span style='color:navy'>MovementVector</span></b>(<span style='color:blue'>new</span>
<b><span style='color:navy'>Point</span></b>(newX, newY), 2));</p>
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892016">3.5<span
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892017">3.6<span
style='font:7.0pt "Times New Roman"'>&nbsp; </span>Rename and Build the animal
DLL.</a></h3>
...
<h3 style='margin-left:.25in;text-indent:-.25in'><a name="_Toc69892018">3.7<span
style='font:7.0pt "Times New Roman"'>&nbsp; </span>Introduce the Herbivore into
the Terrarium in Terrarium Mode.</a>  </h3>
...
<h2><a name="_Toc69892019">Lab Summary</a></h2>
...
<h2><a name="_Toc69892020">Exercise 3 – Introduction into the Ecosystem</a></h2>

<p class=lab2lb1><span style='font-size:10.0pt;font-family:"Microsoft Sans Serif"'>&nbsp;</span></p>
...
your animal, click <b>Open</b>, your animal will be introduced into the Ecosystem,
you should be able to see 10 of your animals on the screen. </p>
...
<h2><a name="_Toc69892021">Lab Summary</a></h2>
