...
ALTER DATABASE [Terrarium] SET ANSI_NULLS OFF
GO

ALTER DATABASE [Terrarium] SET ANSI_PADDING OFF
GO

ALTER DATABASE [Terrarium] SET ANSI_WARNINGS OFF
GO

ALTER DATABASE [Terrarium] SET ARITHABORT OFF
GO

ALTER DATABASE [Terrarium] SET AUTO_CLOSE OFF
GO

ALTER DATABASE [Terrarium] SET AUTO_CREATE_STATISTICS ON
GO

ALTER DATABASE [Terrarium] SET AUTO_SHRINK OFF
GO

ALTER DATABASE [Terrarium] SET AUTO_UPDATE_STATISTICS ON
GO

ALTER DATABASE [Terrarium] SET CURSOR_CLOSE_ON_COMMIT OFF
GO

ALTER DATABASE [Terrarium] SET CURSOR_DEFAULT  GLOBAL
GO

ALTER DATABASE [Terrarium] SET CONCAT_NULL_YIELDS_NULL OFF
GO

ALTER DATABASE [Terrarium] SET NUMERIC_ROUNDABORT OFF
GO

ALTER DATABASE [Terrarium] SET QUOTED_IDENTIFIER OFF
GO

ALTER DATABASE [Terrarium] SET RECURSIVE_TRIGGERS OFF
GO

ALTER DATABASE [Terrarium] SET  ENABLE_BROKER
GO

ALTER DATABASE [Terrarium] SET AUTO_UPDATE_STATISTICS_ASYNC OFF
GO

ALTER DATABASE [Terrarium] SET DATE_CORRELATION_OPTIMIZATION OFF
GO

ALTER DATABASE [Terrarium] SET TRUSTWORTHY OFF
GO

ALTER DATABASE [Terrarium] SET ALLOW_SNAPSHOT_ISOLATION OFF
GO

ALTER DATABASE [Terrarium] SET PARAMETERIZATION SIMPLE
GO

ALTER DATABASE [Terrarium] SET  READ_WRITE
GO

ALTER DATABASE [Terrarium] SET RECOVERY FULL
GO

ALTER DATABASE [Terrarium] SET  MULTI_USER
GO

ALTER DATABASE [Terrarium] SET PAGE_VERIFY TORN_PAGE_DETECTION
GO

ALTER DATABASE [Terrarium] SET DB_CHAINING OFF
GO
